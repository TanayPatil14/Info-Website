...
if(isset($_GET['id'])){
	...
	if($id>0){
		$get_services=get_services($conn,'','',$id);
	}
}
      ...
      <div class="all-projects">
        <div class="project-item">
          <div class="project-info">
            <div class="icon"><img src="https://img.icons8.com/officexs/80/000000/reflector-bulb.png"/></div>
            <h2><<?php echo $get_services['name']?></h2>
